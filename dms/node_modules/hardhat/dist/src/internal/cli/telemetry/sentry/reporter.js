...
export async function setupErrorTelemetryIfEnabled() {
    await Reporter.getInstance(true);
}
export async function sendErrorTelemetry(error) {
...
class Reporter {
    ...
    static async getInstance(shouldSetupErrorHandlers = false) {

 ...
 */
export function createDetachedProcessTransport(dsn, release, environment, configPath) {
    return {
        send: (envelope) => {
...
export async function sendEnvelopeToSentryBackend(dsn, envelope) {
    return sendSerializedEnvelopeToSentryBackend(dsn, serializeEnvelope(envelope));
}
